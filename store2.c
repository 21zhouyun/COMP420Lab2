 ...
 *  what the program does.  This program is similar to store1.c,
 *  except that this version tests some exceptional conditions,
 *  whereas store1.c only tests basic operation.
 *
 ***********************************************************************
 ...
 ***********************************************************************
 *
 *  Run as: rednet -P 1 -N [other_flags] system_prog -- store2 ##
 *
...
main(int argc, char **argv) {
     ...
     *
     *  - Process index 5 does two Insert operations USING THE SAME
     *    FILEID but with different contents.  The second contents
     *    should replace the original contents.
     *
     *  - Process index 12 then does two Lookup operations.  The
     *    first uses the fileID used above and should return the
     *    result of the second Insert.  The second Lookup uses a
     *    fileID that nobody has Inserted and so should return an
     *    error (negative).
     *
     *  - Process index 1 does two Reclaim operations.  As with the
     *    Lookup operations, the first should succeed but the second
     *    should return an error (negative).
     *
